...
public class TestProvider extends AndroidTestCase {
    ...
    /*
       ...
       deleted, so it cannot be used until the Query and Delete functions have een written
...
//    }
    ...
    /*
       ...
       Students: Uncomment this test to verify that your implementations of GetType is
...
//    }
    ...
    /*
       This test uses database directly to insert and then uses the ContentProvider to
       read out the data. Uncomment this test to see if the basic weather query functionality
       given in the ContentProvider is working correctly.
     */
//    public void testBasicWeatherQuery() {
//        // Insert out test records into the database.
//        WeatherDbHelper dbHelper = new WeatherDbHelper(mContext);
//        SQLiteDatabase database = dbHelper.getWritableDatabase();
//
...
//        // isn't calling getContent().getContentResolver().notifyChange(uri, null);
...
//        );
//
//        TestUtilities.validateCursor("testUpdateLocation. Error validation location  entry update.",
...
//        ContentValues testValues = TestUtilities.createNorthPoleLocationValues();
//
//        // Register a content observer for out insert. This time, directly with the content resolver.
//        TestUtilities.TestContentObserver tco = TestUtilities.getTestContentObserver();
//        mContext.getContentResolver().registerContentObserver(LocationEntry.CONTENT_URI, tru, tco);
...
//        // Fantastic. Now that we have a location, add some weather!
//        ContentValues weatherValues = TestUtilities.createWeatherValues(locationRowId);
//        // The TestContentObserver is a one-short class.
...
//        );
//
//        TestUtilities.validateCursor("testInsertReadProvider. Error validation WeatherEntry insert.",
...
//                null // sort order
//        );
//        TestUtilities.validateCursor("testInsertReadProvider. Error validation joined Weather and Location Data.",
//                weatherCursor, weatherValues);
//
//        // Get the joined Weather and Location data with a start date.
//        weatherCursor = mContext.getContentResolver().query(
//                WeatherEntry.buildWeatherLocationWithStartDate(TestUtilities.TEST_LOCATION,
...
//                null // sort order
//        );
//        TestUtilities.validateCursor("testInsertReadProvider. Error validation joined Weather and Location data with start date.",
//                weatherCursor, weatherValues);
//
...
//    }
    ...
    /*
       ...
       implementation, which just insert records one-at-a-time, so really do implement the
       BuildInsert ContentProvider functions.
     */

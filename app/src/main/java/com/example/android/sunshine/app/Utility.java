...
public class Utility {
    ...
    public static String getFriendlyDayString(Context context, long dateInMillis) {
        // The day string for forecast users the following logic:
        // For today: "Today, June 8"
        // For tomorrow: "Tomorrow"
        // For the next 5 days: "Wednesday" (just the day name)
        // For all days after hat: "Mon Jun 8"
        ...
        if (julianDay == currentJulianDay) {
            ...
            return context.getString(formatId, today, getFormatterdMonthDay(context, dateInMillis));
     ...
     */
    public static String getFormatterdMonthDay(Context context, long dateInMillis) {
        Time time = new Time();
        time.setToNow();
